...
import { d as defineCustomElement$4 } from './checkbox-input.js';
import { d as defineCustomElement$3 } from './select-input.js';
import { d as defineCustomElement$2 } from './text-input.js';
...
const FormBuilder = /*@__PURE__*/ proxyCustomElement(class FormBuilder extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.wabBeforeSubmit = createEvent(this, "wabBeforeSubmit", 7);
        this.wabSubmit = createEvent(this, "wabSubmit", 7);
        this.wabAfterSubmit = createEvent(this, "wabAfterSubmit", 7);
        this.wabSubmitError = createEvent(this, "wabSubmitError", 7);
        this.wabBeforeReset = createEvent(this, "wabBeforeReset", 7);
        this.wabAfterReset = createEvent(this, "wabAfterReset", 7);
        this.wabValidationErrors = createEvent(this, "wabValidationErrors", 7);
    ...
    getRightComponent(field) {
        ...
        switch (field.type) {
            ...
            case 'select':
                return (h("wab-select-input", Object.assign({}, field, props, { value: this.formData[field.name] })));
            default:
...
function defineCustomElement$1() {
    ...
    const components = ["wab-form-builder", "wab-checkbox-input", "wab-select-input", "wab-text-input"];
    components.forEach(tagName => { switch (tagName) {
        case "wab-form-builder":
...
const WabFormBuilder = FormBuilder;
const defineCustomElement = defineCustomElement$1;

export { WabFormBuilder, defineCustomElement };

//# sourceMappingURL=wab-form-builder.js.map