...
const formBuilderCss = ":host{display:block}";
...
const FormBuilder = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { class: { 'loading': this.loading } }, index.h("form", { action: this.action, method: this.method, ref: el => (this.formEl = el), onSubmit: e => this.onSubmit(e), onReset: e => this.onReset(e) }, index.h("slot", null), (_a = this.formSchema) === null || _a === void 0 ? void 0 :
            _a.fields.map(field => this.getRightComponent(field)), index.h("slot", { name: 'actions' }, index.h("button", { type: 'reset', part: 'resetBtn', disabled: this.loading }, "Reset"), index.h("button", { type: 'submit', part: 'submitBtn', disabled: this.loading }, "Submit")))));
    }
...
//# sourceMappingURL=wab-checkbox-input_3.cjs.entry.js.map