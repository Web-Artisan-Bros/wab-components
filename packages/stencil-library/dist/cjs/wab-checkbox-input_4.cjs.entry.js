...
const CheckboxInput = class {
    ...
    render() {
        return (index.h(index.Host, { class: "wab-form-control" }, index.h("label", { part: "label" }, this.labelPosition === 'left' && index.h("span", { part: 'labelText' }, this.label), index.h("input", { part: "input", type: "checkbox", checked: this.checked, id: this.id, disabled: this.disabled, value: this.value, style: { display: this.useNative ? 'inline-block' : 'none' }, onInput: e => this.valueChangedHandler(e), onChange: e => this.valueChangedHandler(e, 'change') }), this.useNative ? null : (index.h("span", { part: "customInput" }, index.h("span", { part: "customInputCheckmark" }))), this.labelPosition === 'right' && index.h("span", { part: 'labelText' }, this.label)), index.h("slot", { name: 'details' }, this.details && index.h("div", { part: 'details' }, this.details)), index.h("slot", { name: 'errors' }, this.errors && index.h("div", { part: 'errors' }, this.errors))));
    }
};
CheckboxInput.style = wabInputCss$2 + checkboxInputCss;
...
const formBuilderCss = ":host {\n  display: block;\n  \n  * {\n    -webkit-box-sizing: border-box;\n    box-sizing: border-box;\n  }\n}\n";

const FormBuilder = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.wabBeforeSubmit = index.createEvent(this, "wabBeforeSubmit", 7);
        this.wabSubmit = index.createEvent(this, "wabSubmit", 7);
        this.wabAfterSubmit = index.createEvent(this, "wabAfterSubmit", 7);
        this.wabSubmitError = index.createEvent(this, "wabSubmitError", 7);
        this.wabBeforeReset = index.createEvent(this, "wabBeforeReset", 7);
        this.wabAfterReset = index.createEvent(this, "wabAfterReset", 7);
        this.wabValidationErrors = index.createEvent(this, "wabValidationErrors", 7);
    ...
    buildValidatorSchema() {
        ...
        this.formValidator = create$3(rawSchema);
    }
    /**
    ...
    getRightComponent(field) {
        ...
        switch (field.type) {
            ...
            case 'email':
            case 'password':
                return (index.h("wab-text-input", Object.assign({}, field, props, { value: this.formData[field.name], onKeyUp: e => e.key === 'Enter' && this.formEl.requestSubmit() })));
            case 'checkbox':
                return (index.h("wab-checkbox-input", Object.assign({}, field, props, { checked: this.formData[field.name] })));
            case 'select':
                return (index.h("wab-select-input", Object.assign({}, field, props, { value: this.formData[field.name] })));
            default:
                return index.h("div", null, "Unknown field type");
        }
    }
    /**
     * Lifecycle hook
    ...
    render() {
        var _a;
        return (index.h(index.Host, { class: { 'loading': this.loading } }, index.h("form", { action: this.action, method: this.method, ref: el => (this.formEl = el), style: { display: this.showAfterSubmitEl ? 'none' : '' }, onSubmit: e => this.onSubmit(e), onReset: e => this.onReset(e) }, index.h("slot", null), (_a = this.formSchema) === null || _a === void 0 ? void 0 :
            _a.fields.map(field => this.getRightComponent(field)), index.h("slot", { name: 'actions' }, index.h("button", { type: 'reset', part: 'resetBtn', disabled: this.loading }, "Reset"), index.h("button", { type: 'submit', part: 'submitBtn', disabled: this.loading }, "Submit"))), index.h("div", { ref: (e) => this.afterSubmitSlot = e, style: { display: this.showAfterSubmitEl ? 'block' : 'none' } }, index.h("slot", { name: "afterSubmit" }))));
    }
...
const SelectInput = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { class: "wab-form-control" }, index.h("slot", { name: "label" }, this.label && (index.h("label", { part: "label", htmlFor: this.id }, this.label))), index.h("div", { part: "input-wrapper", id: this.id, tabindex: "0", onFocusin: (e) => this.toggleFocus(e, true), onFocusout: (e) => this.toggleFocus(e, false), onKeyUp: e => this.onKeyUp(e), class: { 'focus': this.isDropdownOpen } }, index.h("div", { part: "input", onFocusin: e => e.stopPropagation(), onFocusout: e => e.stopPropagation(), class: { 'placeholder': !this.inputValue } }, (_b = (_a = this.inputValue) !== null && _a !== void 0 ? _a : this.placeholder) !== null && _b !== void 0 ? _b : '\xa0'), index.h("ul", { part: "dropdown", ref: (e) => this.dropdownEl = e }, (_c = this.options) === null || _c === void 0 ? void 0 : _c.map(option => {
            var _a, _b;
            return (index.h("li", { part: "dropdown-item", key: option.value, "data-value": option.value, onClick: () => this.onOptionSelect(option), class: {
        ...
        }))), index.h("slot", { name: "details" }, this.details && index.h("div", { part: "details" }, this.details)), index.h("slot", { name: "errors" }, this.errors && index.h("div", { part: "errors" }, this.errors))));
    }
    static get watchers() { return {
        "value": ["onValueChanged"]
    }; }
};
SelectInput.style = wabInputCss$1 + selectInputCss;
...
const TextInput = class {
    ...
    render() {
        return (index.h(index.Host, { class: "wab-form-control" }, index.h("slot", { name: "label" }, this.label && (index.h("label", { part: "label", htmlFor: this.id }, this.label))), index.h("input", { part: 'input', type: this.type, placeholder: this.placeholder, value: this.value, id: this.id, disabled: this.disabled, readonly: this.readonly, onInput: e => this.valueChangedHandler(e), onChange: e => this.valueChangedHandler(e, 'change') }), index.h("slot", { name: "details" }, this.details && index.h("div", { part: "details" }, this.details)), index.h("slot", { name: "errors" }, this.errors && index.h("div", { part: "errors" }, this.errors))));
    }
};
TextInput.style = textInputCss + wabInputCss;

exports.wab_checkbox_input = CheckboxInput;
exports.wab_form_builder = FormBuilder;
exports.wab_select_input = SelectInput;
exports.wab_text_input = TextInput;

//# sourceMappingURL=wab-checkbox-input_4.cjs.entry.js.map