...
export class FormBuilder {
    ...
    static get events() {
        return [{
                "method": "wabBeforeSubmit",
                "name": "wabBeforeSubmit",
                "bubbles": true,
                "cancelable": true,
                "composed": true,
                "docs": {
                ...
                "method": "wabValidationErrors",
                "name": "wabValidationErrors",
                "bubbles": true,
                "cancelable": true,
                "composed": true,
                "docs": {
                ...
                "complexType": {
                    "original": "{ formData: Record<string, any>, errors: ValidationError }",
                    "resolved": "{ formData: Record<string, any>; errors: ValidationError; }",
                    "references": {
                        "Record": {
                            "location": "global",
                            "id": "global::Record"
    ...
    static get methods() {
        return {
            "getFormData": {
                ...
                "docs": {
                    "text": "Return the actual form data",
                    "tags": []
                }
            }
        };
    ...
    static get watchers() {
        return [{
                ...
                "propName": "submitComplete",
                "methodName": "onAfterSubmitSlotChange"
            }];
    }
}
